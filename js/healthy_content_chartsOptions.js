...
function initCharts(id, ydata, xdata = ['5', '10', '15', '20', '25', '30', '60']) {
    options[id].xAxis.data = xdata
    options[id].series[0].data = ydata
    var ele = document.getElementById(id);
    charts[id] = echarts.init(ele);
    charts[id].setOption(options[id]);
}

function editCharts(id, ydata, xdata = ['5', '10', '15', '20', '25', '30', '60']) {
    options[id.slice(2)].xAxis.data = xdata
    options[id.slice(2)].series[0].data = ydata
    charts[id.slice(2)].setOption(options[id.slice(2)]);
}
(function () {
